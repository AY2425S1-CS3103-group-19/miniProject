...
let socket, audioContext, mediaStream, audioProcessor, client_sample_rate, student_id;
...
function connect() {
    ...
    socket.onopen = () => {
        ...
        const msg = JSON.stringify({ type: MESSAGE_TYPES.SEND_STUD_ID, student_id: student_id });
        socket.send(msg);
